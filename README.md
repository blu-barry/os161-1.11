...
```
cd existing_repo
git remote add origin https://git.cec.gmu.edu/mbarry6/os161-1.11.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cec.gmu.edu/mbarry6/os161-1.11/-/settings/integrations)
